...
export default function About() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-slate-950 pt-24 pb-20 transition-colors">
      <div className="container mx-auto px-6 max-w-6xl">
        ...
        <section className="text-center mb-24">
          <motion.div
            ...
            className="w-24 h-24 bg-indigo-50 dark:bg-indigo-950/40 rounded-full flex items-center justify-center mx-auto mb-8 border border-indigo-100 dark:border-indigo-800/60 p-2 shadow-xl shadow-indigo-600/5"
          >
          ...
          <motion.h1 
            ...
            className="text-5xl md:text-6xl font-serif font-medium text-slate-900 dark:text-white mb-6"
          >
          ...
          <motion.p 
            ...
            className="text-xl text-gray-600 dark:text-slate-300 max-w-3xl mx-auto leading-relaxed"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center mb-32">
          <motion.div
            ...
            className="space-y-8"
          >
            <h2 className="text-4xl font-serif font-medium text-slate-900 dark:text-white leading-tight">
              Excelência no Coração da <span className="text-indigo-600 dark:text-indigo-400">Bacia do Rio Corrente</span>
            </h2>
            <div className="space-y-6 text-gray-600 dark:text-slate-300 leading-relaxed text-justify">
              <p>
            ...
            <div className="flex gap-12 pt-4">
              <div>
                <span className="block text-4xl font-black text-indigo-900 dark:text-indigo-400">15+</span>
                <span className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest">Anos de História</span>
              </div>
              <div>
                <span className="block text-4xl font-black text-indigo-900 dark:text-indigo-400">2000+</span>
                <span className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest">Alunos Formados</span>
              </div>
              <div>
                <span className="block text-4xl font-black text-indigo-900 dark:text-indigo-400">10+</span>
                <span className="text-sm font-bold text-gray-400 dark:text-slate-400 uppercase tracking-widest">Cursos Técnicos</span>
              </div>
            </div>
          </motion.div>
          <motion.div
          ...
          >
            <div className="aspect-square bg-indigo-50 dark:bg-slate-900 rounded-[80px] overflow-hidden relative border-[16px] border-white dark:border-slate-800 shadow-2xl">
              ...
              />
              <div className="absolute inset-0 bg-indigo-900/10 dark:bg-indigo-950/30 mix-blend-multiply" />
            </div>
            {/* Decors */}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
           {values.map((v, i) => (
             <motion.div
               ...
               className="bg-gray-50 dark:bg-slate-900 p-10 rounded-[48px] border border-transparent dark:border-slate-800 hover:border-indigo-100 dark:hover:border-indigo-800 hover:bg-white dark:hover:bg-slate-850 transition-all group"
             >
               <div className="w-16 h-16 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center mb-8 shadow-sm group-hover:bg-indigo-600 group-hover:text-white transition-all border border-slate-100 dark:border-slate-700">
                  <v.icon className="w-8 h-8 text-indigo-600 group-hover:text-white" />
               </div>
               <h3 className="text-2xl font-serif font-medium mb-4 text-slate-900 dark:text-white">{v.title}</h3>
               <p className="text-gray-500 dark:text-slate-400 leading-relaxed italic">{v.desc}</p>
             </motion.div>
           ))}
        </div>

        {/* Contact Info Footer */}
        <section className="bg-indigo-950 dark:bg-slate-900 p-16 rounded-[60px] text-white relative overflow-hidden shadow-2xl border border-indigo-900 dark:border-slate-800">
