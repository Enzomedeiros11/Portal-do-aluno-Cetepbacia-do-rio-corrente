        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                return (
                  ...
                  >
                    <div className="relative z-10 flex-1">
                      ...
                      <h3 className="text-2xl font-serif font-medium mb-3 group-hover:text-indigo-700 transition-colors">
                        {course.title}
                      </h3>
                      ...
                      {isExcel && (
                        <div className="mb-6 p-3.5 bg-slate-50 rounded-2xl border border-slate-100 space-y-2">
          ...
          <aside className="space-y-6">
            ...
            <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm text-center">
              ...
              <p className="text-sm text-gray-500 mb-6">Mande sua dúvida no chat de inteligência artificial ou fale com o professor.</p>
              <a
                href="/contact"
